...
const scrapRouter = require('./api/routes/web-scraping');
const masterRouter = require('./api/routes/master-router');
counter = 0;
// cron.schedule('* * * * * *', () => {
   
//    var indexData = getIndexGeom(counter);
//    setTimeout(() => {
//     scrapData(indexData)
//    }, 2000);
//   });
...
async function scrapData(id) {
    ...
    try {
       ...
       var d = response.data;
       console.log(d.main && d.main.temp,'temp',id,'math random',counter++);
      } catch (error) {
